...
def print_summary(exporter, logger):
    ...
    logger.write("GREENHOUSE SUMMARY")
...
def scrape(base_url, output_folder):
    """
    Main entry point for the Greenhouse scraper.
    """
    ...
    master_file = os.path.join(
        master_dir,
        "Master_Greenhouse.xlsx"
    )

    logger.write("=" * 70)
    logger.write("GREENHOUSE SCRAPER STARTED")
    logger.write("=" * 70)
    ...
    try:
        ...
        logger.write(
            ...
            "\nGreenhouse scraping completed successfully."
        ...
        logger.write("=" * 70)
        logger.write("GREENHOUSE SCRAPER FINISHED")
        logger.write("=" * 70)