...
def scrape(base_url, output_folder):
    """
    Main entry point for the Lever scraper.
    """
    ...
    logger.write("=" * 70)
    logger.write("LEVER SCRAPER STARTED")
    logger.write("=" * 70)
    ...
    try:
        ...
        logger.write(
            ...
            "\nLever scraping completed successfully."
        ...
        logger.write("=" * 70)
        logger.write("LEVER SCRAPER FINISHED")
        logger.write("=" * 70)