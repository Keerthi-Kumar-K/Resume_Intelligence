...
def collect_links(driver):
    ...
    for anchor in anchors:
        ...
        if "oraclecloud.com" in lower:

            urls.add(href)

            continue

        if "oracle.com/careers" in lower:
...
def get_title(driver):
    ...
    selectors = [
        ...
        "[data-automation-id='posting-title']"
...
def get_company(driver):
    ...
    selectors = [
        ...
        "[data-automation-id='employerName']"
...
def scrape(base_url, output_folder):
    """
    Main entry point for the Oracle scraper.
    """
    ...
    logger.write("=" * 70)
    logger.write("ORACLE SCRAPER STARTED")
    logger.write("=" * 70)
    ...
    try:
        ...
        logger.write(
            ...
            "\nOracle scraping completed successfully."
        ...
        logger.write("=" * 70)
        logger.write("ORACLE SCRAPER FINISHED")
        logger.write("=" * 70)