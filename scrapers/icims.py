...
def scrape(base_url, output_folder):
    """
    Main entry point for the iCIMS scraper.
    """
    ...
    logger.write("=" * 70)
    logger.write("ICIMS SCRAPER STARTED")
    logger.write("=" * 70)
    ...
    try:
        ...
        logger.write(
            ...
            "\niCIMS scraping completed successfully."
        ...
        logger.write("=" * 70)
        logger.write("ICIMS SCRAPER FINISHED")
        logger.write("=" * 70)